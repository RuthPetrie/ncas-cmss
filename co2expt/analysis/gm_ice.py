...
expt_seq='sia_tot_seq_nh.nc'
expt_strong='sia_tot_double_nh.nc'
expt_main='sia_tot_single_nh.nc'
#ctrl='ctrl_gm.nc'
...
plt.savefig('global_mean_sea_ice_decline.png')
plt.show()
