...
double_t_diff, lons = addcyclic(double_t_diff, lons)
double_t_diff, lons = shiftgrid(180, double_t_diff, lons)
...
clevs=np.arange(-2,20,2) #levels
cs = mymap.contourf(x,y,double_t_diff,clevs, cmap=cmap, extend='both')
...
plt.title('Temperature difference for double rate increase senario from control', y=1.03)

plt.savefig('temp_diff_2050_double.png')
plt.show()
#############################################
