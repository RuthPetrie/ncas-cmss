...
ax1.plot(xpts, sia_single, color="blue", label='Single rate inc.')
ax1.plot(xpts, sia_double, color="green", label='Double rate inc.')
#ax1.plot(xpts_ctrl, temp_ctrl[0:450], color="black", label='Control')
plt.title('Sea ice decline anomaly: SON')
...
plt.savefig('nh_mean_sea_ice_decline_son_anom.png')
plt.show()
