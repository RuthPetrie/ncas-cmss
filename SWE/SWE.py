...
nt = 1440      # total number of time-steps
ntPlot = 1440     # plot every ntPlot time-steps
...
[hCinit, uCinit, vCinit] = [hC, uC, vC]
[hAinit, uAinit, vAinit] = [hA, uA, vA]
...
for it in range(0,nt,ntPlot):
    ...
    plothuv(x, y, xu,yu, xv, yv, hC, h0, uC, vC,'Cfinal.pdf')
...
#    plothuv(x, y, x,y, x, y, hA, h0, uA, vA, 'Afinal.pdf')
...
#py.figure(3)
#plothuv(x, y, xu,yu, xv, yv, hCerr, h0, uCerr, vCerr, 'Cerr.pdf')
...
#py.figure(4)
#plothuv(x, y, xu,yu, xv, yv, hAerr, h0, uAerr, vAerr,'Aerr.pdf')
